...
{\bf Peking University (PKU)} , Beijing, China \hfill {Sep. 2015 -- Current}
% \vspace{-.3cm}
\begin{list2}
...
\begin{list2}
%
\item{\underline{\bf C. Jia}, S. Wang, X. Zhang, S. Wang and S. Ma, ``Spatial-Temporal Residue Network Based In-Loop Filter for Video Coding", {\em {\bf Accepted} by IEEE Visual Communications and Image Processing ({\bf VCIP})}, St. Petersburg, Florida, USA, Dec, 2017. (TBD)}

%
\item{\underline{\bf C. Jia}, Y. Yang, X. Zhang, S. Wang, X. Zhang, S. Wang and S. Ma, ``Optimized Inter-view Prediction Based Light Field Image Compression with Adaptive Reconstruction", {\em {\bf Accepted} by IEEE International Conference on Image Processing ({\bf ICIP}}) grand challenge for LF image compression, Beijing, China, Sept, 2017. (Oral)}

%
\item{\underline{\bf C. Jia}, Y. Yang, X. Zhang, S. Wang, S. Wang and S. Ma, ``Light Field Image Compression with Sub-apertures Reordering and Adaptive Reconstruction", {\em {\bf Accepted} by the Pacific-Rim Conference on Multimedia ({\bf PCM}}), Harbin, China, Sept, 2017. (TBD)}
...
\begin{subsection}{\normalsize View Synthesis Optimization, ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  Apr. 2016 - Sep. 2016}
    \item{Optimizing an open-source view synthesis software using CUDA. 6x fps acceleration, achieving real time FHD (1080P) view synthesis with over 40fps.}
\end{subsection}
...
\begin{center}
\textit{Last updated: August 25th 2017}
